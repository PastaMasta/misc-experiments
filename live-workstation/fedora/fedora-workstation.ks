...
# Move big dirs under tmp

rmdir ~liveuser/Downloads
mkdir /tmp/Downloads
chown liveuser:liveuser /tmp/Downloads
ln -f -s /tmp/Downloads ~liveuser/Downloads

mkdir /tmp/.wine
chown liveuser:liveuser /tmp/.wine
ln -f -s /tmp/.wine ~liveuser/.wine
